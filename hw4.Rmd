...
ggplot(data = df, aes(x = df$radius, y = df$rate.total)) + 
  geom_point(aes(colour = df$radius)) + 
  geom_line(aes(colour = df$radius), size = 1) + 
  xlab("Minimum Distance") +
  ylab("Rate") + 
  ggtitle("Cumulative Distribution between Minimum Distance and Rate")
